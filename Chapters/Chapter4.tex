...
% como root en el servidor de git, cambiamos la clave del usuario de git:
%passwd git
% desde el servidor/usuario de EduNube:
%cd .ssh/
%ssh-keygen -f id_git
% Deja la llave sin clave
...
\begin{lstlisting}
pipenv --three
pipenv install django six psycopg2 PyJWT bcrypt ipython requests
...
pipenv lock --requirements | awk '{print $1}' > requirements.txt
\end{lstlisting}
