...
%mkdir -p /srv/bitnami
%chown 1001:1001 -Rc /srv/bitnami 
%docker run -d --name mariadb -e ALLOW_EMPTY_PASSWORD=yes --net moodle-tier --volume /srv/bitnami/moodle/mariadb:/bitnami --restart always bitnami/mariadb
%docker run -d -p 8201:80 -p 8243:443 --name moodle --net moodle-tier --volume /srv/bitnami/moodle/moodle:/bitnami --restart always bitnami/moodle
