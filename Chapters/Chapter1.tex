...
\begin{itemize}
	\item Autenticar contra LTI \index{LTI} de los sistemas LMS \index{LMS} institucionales. Esto permite que los estudiantes pueden autenticarse dentro del sistema sin crear nuevos cuentas de usuario con los nuevos nombres de usuario y contraseñas que el mismo involucra. \index{Autenticación LTI} 
