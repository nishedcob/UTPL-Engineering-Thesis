...
\begin{figure}
  ...
  \end{center}
  \caption{Sistema de Control de Versionamiento Distribuido. Fuente: \citep{PROGIT-VCS}.}
  \label{DVCS}
\end{figure}
...
El cuadro \ref{tecnologias-web} presenta conceptos de varias tecnologias que existen en la web hoy en dia.
