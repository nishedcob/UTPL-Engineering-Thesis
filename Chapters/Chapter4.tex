...
# meter en ubicación para apache
mv moodle /var/www

# ir a ubicación para apache
cd /var/www
...
Para la persistencia de código en MongoDB se define unos modelos de base de datos en Python para su utilización con el ORM PyModm. A continuacion se presenta el model de base de datos para MongoDB:
...
\item Basada en Criptográfica Asimétrica para ofrecer mayor seguridad y permitir integración con otros sistemas como GitEDU
\end{itemize}
