...
\end{itemize}
El codigo completo de este backend se encuentra en el paquete ideApp.CodePersistenceBackends en el archivo backend\_manager.py con el nombre de clase CodePersistenceBackendManager que se puede encontrar en el Apendice \ref{AnexoF}.
