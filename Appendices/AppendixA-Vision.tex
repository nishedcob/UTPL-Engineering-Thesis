...
\subsubsection{Necesidades de Interesados y Usuarios Principales}
...
\subsubsection{Alternativas y Competidores}
\begin{enumerate}
	\item Repl.it
    \item Cloud9 IDE
\end{enumerate}
...
\begin{figure}
  \begin{center}
    %\includegraphics[width=0.5\textwidth]{Figures/pers-prod.png}
  \end{center}
