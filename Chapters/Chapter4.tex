...
# meter en la ubicaci\'on para apache
mv moodle /var/www

# ir a ubicaci\'on para apache
cd /var/www

# crear ubicaci\'on para datos
mkdir moodledata
...
# modificar configuraci\'on de apache
...
LTI_OAUTH_CREDENTIALS = {
    ...
    "GitEduLMS_Playground_Assignments":
         ...
         # (Para deberes/ex\'amenes/pruebas/talleres/etc)
