...
%docker run -d --name mariadb -e ALLOW_EMPTY_PASSWORD=yes --net moodle-tier --restart always bitnami/mariadb
%docker run -d -p 8201:80 -p 8243:443 --name moodle --net moodle-tier --restart always bitnami/moodle
