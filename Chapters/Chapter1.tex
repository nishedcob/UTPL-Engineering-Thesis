...
e integrar funcionalidades de sistemas LMS \index{LMS} institucionales en adición a servidores de control de versiones institucionales. Para alcanzar este fin, también se plantea cumplir con algunos objetivos específicos en vía al principal. \index{Editar Código|textit}

\begin{itemize}
	\item Facilitar la autenticación de los estudiantes para que puedan entrar directamente desde sistemas LMS \index{LMS} institucionales a través del protocolo LTI\index{LTI}. Eso es necesario con la finalidad de que estudiantes pueden tener una transición suave entre sistemas y no tener mayor interupción en su aprendizaje. \index{Autenticación LTI}
