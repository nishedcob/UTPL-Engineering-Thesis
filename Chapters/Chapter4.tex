...
Instalacion de dependencias desde GitHub (no se encuentran en los repositorios oficiales de Pip/Pypi):
\begin{lstlisting}
pip install git+https://github.com/Harvard-ATG/django-app-lti
	@master#egg=django-app-lti
pip install git+https://github.com/Harvard-University-iCommons/
...
\begin{lstlisting}
-e git+https://github.com/Harvard-ATG/django-app-lti.git
	@f7d8d3f085fbc96f5acbff405610050cffd2b274
	#egg=django-app-lti
-e git+https://github.com/Harvard-University-iCommons/
	django-auth-lti.git
	@76ec7e049946abbd8e2b55bbcd90dc86df0f66ea
	#egg=django-auth-lti
\end{lstlisting}
...
Para arreglar un problema de una version muy desactualizada de ims-lti-py, se agrego la siguiente linea al requirements.txt:
\begin{lstlisting}
-e git+https://github.com/tophatmonocle/ims_lti_py.git
