...
\begin{itemize}
  ...
  \item un servicio para recibir peticiones HTTP y convertirlos en sus respetivos objetos en un repositorio de Git (Git Server HTTP Endpoint)
  \item un LMS (Moodle),
  \item un servidor de Git (GitLab CE)
  \item un servidor de Virtualizacion (Docker)
...
\item la ubicación del archivo dentro del repositorio incluyendo su nombre y un archivo de cambio que representa el estado actual y la última modificación realizada en el mismo, de lo cual se presenta más adelante.
\end{itemize}
