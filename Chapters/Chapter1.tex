...
\begin{itemize}
	\item Dar facilidad de autenticacion a los estudiantes para que puedan entrar directamente desde sistemas LMS \index{LMS} institucionales a través del protocolo LTI \index{LTI} con la finalidad pueden iniciarse session dentro del sistema sin crear nuevos cuentas de usuario con los nuevos nombres de usuario y contraseñas que el mismo involucra. \index{Autenticación LTI} 
