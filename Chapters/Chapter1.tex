...
\section{Metodología}
Se plantea llevar este proyecto bajo una metodología de desarrollo iterativo incremental marcado por prototipos que se revisan de forma contínua con los stakeholders principales del proyecto. De esta forma se puede mantener un poco de agilidad en el desarrollo y de esta manera, desarrollar un producto que cumple con las necesidades de los usuarios mientras que se mantiene dentro de los límites de tiempo y recursos preestablecidos. Dentro de la metodología que se plantea para el proyecto, se propone no tener ninguna iteración (basado en un entregable) que dure más de un mes, de lo cual solo se lo propone para los dos entregables más grandes; el subsistema de ejecución de código por su complejidad y el capítulo seis que se trata del despliegue de la aplicación final. Todos los demás iteraciones son de dos semanas para tratar de mantener el proyecto en un estado fluido de actividad y entrega de entregables de forma contínua.

\section{Objetivos}
El objetivo principal es mejorar la enseñanza y evaluación de estudiantes de programación de la Universidad Técnica Particular de Loja. Para cumplir este objetivo se propone un sistema de editar y probar código en línea que ayuda a docentes calificar código que escriben sus estudiantes en base a pruebas unitarias e integra funcionalidades de sistemas LMS institucionales en adición a servidores de control de versiones institucionales. Para alcanzar este fin, también se plantea cumplir con algunos objetivos secundarios en vía al principal. 

Primero, se necesita una capacidad de poder autenticar contra LTI de los sistemas LMS institucionales. Esto permite que los estudiantes pueden autenticarse dentro del sistema sin crear nuevos cuentas de usuario con los nuevos nombres de usuario y contraseñas que el mismo involucra.

Segundo, se requiere la capacidad de poder ejecutar código en línea. Con esta funcionalidad, el sistema se acerca más a un entorno completo de desarrollo donde estudiantes requieren un mínimo de programas instalados en sus equipos personales.

Tercero, una vez que se puede ejecutar código en línea, se puede también autocalificar código en base a pruebas unitarias. El fin de esta característica es que el sistema sea un apoyo a los docentes en ayudarles automatizar y por lo tanto optimizar su flujo de calificar para que tengan más tiempo para estar enseñando y ayudando sus alumnos. Las mismas pruebas unitarias, por la forma en que automatizan la forma en que se pueden usar para calificar código en base a las funcionalidades que tiene y cómo reacciona frente ciertas entradas, también hace el proceso completamente objetivo debido a que elimina el factor humano del proceso.

Cuarto, con el código calificado de forma automática o en algunos casos especiales a mano por el profesor (por ejemplo cuando no hay posibilidad de probar la funcionalidad pedida con solo pruebas unitarias), se requiere que puede sincronizar las notas con sistemas LMS institucionales a través de LTI. Eso dejará que estudiantes pueden revisar instantáneamente su nota una vez que está publicado y también que professores no tienen que estar transfiriendo notas entre sistemas distintas.

Quinto, como capa de persistencia, se propone utilizar servidores de sistemas de control de versiones de la institución para recolectar código en los mismos. Eso permitirá, de una forma transparente y sin mayor interacción del usuario, ver un historial de código escrito en la plataforma y también servir de respaldo continuo del trabajos que realizan los estudiantes.

Sexto, hay una necesidad para recolectar datos para la toma de decisiones estratégicas. Esta característica permite a la administración de la aplicación sea la universidad o equipo de mantenimiento puede sacar datos y estadísticas de uso de la aplicación para en base a ello realizar análisis de cómo se está siendo usado, que son los comportamientos de los estudiantes y otras decisiones estratégicas que se pueden tomar en base a los datos de uso del sistema.

\section{Resultados Esperados}
\textbf{Sistema para Editar Código en Línea} que permite a los estudiantes y sus docentes tener una herramienta más para mejorar el proceso de enseñanza, aprendizaje y evaluación de la programación.
\textbf{Sistema de Ejecutar Código en Línea} que se integra con lo anterior que facilita las pruebas que quieren realizar un estudiante o profesor con respeto a algún codigo al cual tengan acceso.
\textbf{Repositorio de datos recolectados para la toma de decisiones estratégicos} que permite a la titulación ver cómo se está utilizando el sistema y en base a ello planificar decisiones futuras.
\textbf{Manual de Programador} que sea una ayuda para futuros desarrolladores que deseen extender la funcionalidades del sistema inicial.
\textbf{Manual de Usuario} que apoya a estudiantes y docentes que quieren aprender a usar el nuevo sistema.
\textbf{Manual de Mantenimiento/Administrador} que ayuda al equipo de mantenimiento poder mantener la aplicación al corto, mediano y largo plazo.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% OLD CONTENT FROM TEMPLATE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
