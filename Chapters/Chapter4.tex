...
% TODO: summarize API and auth token management
\paragraph{Tokens de Autenticacion}
% TODO: describe CRUD for tokens
\paragraph{API externa}
% TODO: define parameters
% TODO: indicate location of example client
...
% TODO: Overview Code Execution

\subsection{Metadatos de Plantillas}
% TODO: Discuss types of Template Metadata
% TODO: Security/Functionality Model
...
El \texttt{.edunubeignore.children} tiene una funcionalidad similar al \texttt{.edunubeignore} pero permite el copia de archivos 
% TODO: Ignore this list of files for all my children
\subsubsection{.repospec}
% TODO: Secure identification of parent
