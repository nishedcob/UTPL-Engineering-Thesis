...
Tambien se debe tomar en consideracion quien se encarga de los datos que recolecta el sistema ya que, en las palabras del Ingeniero Nelson Piedra (2016), los "datos son el oro o petroleo" de la epoca de la informacion, especialmente cuando la exploitacion de las mismas puede generar nueva informacion y conocimiento muy valioso \citep{Piedra-Nelson-BLD} \citep{Chicaiza-Piedra-SBC} \citep{Lopez-Jorge} \citep{Lopez-Jorge-ArqApp}.
% TODO: agregar critico adicicional; Quien maneja los datos? Los "datos son el oro/petroleo" (y la informacion/conocimiento que se genera con los mismos es lo mas valisioso) de la epoca de la informacion. -- Ing. Piedra, Business Linked Data 2016-2017; Dr. López, Conversaciones de la Tesis y Arquitectura de Aplicaciones (2017-2018, 2016-2017); Ing. Chicaiza y Ing. Piedra, Sistemas Basados en el Conocimiento (2017)
