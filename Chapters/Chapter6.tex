...
$SYSTEMCTL $STAT $SERVICE
    ...
    \item Crear un hook post-receive de Git (version minimo 2.4.12) \texttt{.git/hooks/post-receive}:
    \begin{lstlisting}
#!/bin/bash
#
## Originally:
...
GIT_DIR="" # No es necesario utilizar eso con repositorios completos, solo en el caso de repositorios bare
