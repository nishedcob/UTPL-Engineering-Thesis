...
La implementación de la conexión al API de GitLab se presenta en el Anexo \ref{AnexoD}.
...
\subsubsection{Passthrough de API de EduNube en GitEDU para su consumo con AJAX}
